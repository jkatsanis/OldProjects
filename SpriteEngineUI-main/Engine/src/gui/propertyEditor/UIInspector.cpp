...
void s2d::UIInspector::backgroundSetting()
{
	if (ImGui::TreeNode("Background"))
	{
		...
		ImGui::SetCursorPos(ImVec2(cursorPs.x + 30, cursorPs.y - 6));
		ImGui::InputFloat("##R", &this->backgroundColor.x, 0, 0, "%g");
		ImGui::PopItemWidth();

		//Green
		ImGui::SetCursorPos(ImVec2(cursorPs.x + 100, cursorPs.y));
		ImGui::Text("G");
		ImGui::PushItemWidth(55);
		ImGui::SetCursorPos(ImVec2(cursorPs.x + 30 + 100, cursorPs.y - 6));
		ImGui::InputFloat("##G", &this->backgroundColor.y, 0, 0, "%g");
		ImGui::PopItemWidth();

		//Blue
		ImGui::SetCursorPos(ImVec2(cursorPs.x + 200, cursorPs.y));
		ImGui::Text("B");
		ImGui::PushItemWidth(55);
		ImGui::SetCursorPos(ImVec2(cursorPs.x + 30 + 200, cursorPs.y - 6));
		ImGui::InputFloat("##B", &this->backgroundColor.z, 0, 0, "%g");
		ImGui::PopItemWidth();
...
void s2d::UIInspector::physicsBodyComponent()
{
	...
	if (ImGui::Button(ICON_FA_TRASH "##P"))
	{
...
char* s2d::UIInspector::getInput()
{
	...
	std::string* splittetSring = std::splitString(this->m_currentSpriteInInspector->path, "/", val);
	std::string* splittetSrin2 = std::splitString(this->m_currentSpriteInInspector->path, "\\", val2);
