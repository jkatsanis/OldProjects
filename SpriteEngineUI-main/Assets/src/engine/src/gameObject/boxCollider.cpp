...
s2d::BoxCollider::BoxCollider()
    : isSolid(false), canCollide(false), exists(false), isInCollision(false), sprite(nullptr), collidingSprite(nullptr) { }

s2d::BoxCollider::BoxCollider(s2d::Sprite* sprite)
   : exists(false), isInCollision(false), collidingSprite(nullptr), sprite(sprite), canCollide(false), isSolid(false) { }
...
void s2d::BoxCollider::checkPositions(const BoxCollider& other, const int jIndex)
{
    ...
    {
        this->positionData.position[jIndex] = s2d::BoxColliderPositionData::Position::Down;
    }
    else if (checkRightPosition(other))
    {
        this->positionData.position[jIndex] = s2d::BoxColliderPositionData::Position::Right;
    }
    else if (checkLeftPosition(other))
    {
        this->positionData.position[jIndex] = s2d::BoxColliderPositionData::Position::Left;
    }
    else if (checkUpPosition(other))
    {
        this->positionData.position[jIndex] = s2d::BoxColliderPositionData::Position::Up;
    }
}
